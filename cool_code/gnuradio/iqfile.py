...
# Author: Based on Dr.Moonshine IQ/Recorder
...
class iqfile(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "iqfile")
        ...
        self.connect((self.analog_agc3_xx_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
...
def main(top_block_cls=iqfile, options=None):
