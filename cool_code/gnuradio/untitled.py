...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_hackrf_source_0.set_frequency(0, freq_in_hz)
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.blocks_correctiq_auto_0, 0))
    ...
    def set_freq_in_hz(self, freq_in_hz):
        ...
        self.soapy_hackrf_source_0.set_frequency(0, self.freq_in_hz)
